...
## Expected Output
- `crates/cortex-benchmarks/src/bin/benchmark.rs` implemented
- `crates/cortex-benchmarks/src/runners.rs` core functionality
...
2. Create crates/cortex-benchmarks/src/runners.rs:
...
3. Update crates/cortex-benchmarks/Cargo.toml to add CLI dependencies:
