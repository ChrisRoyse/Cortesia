...
use crate::core::types::{EntityData, Relationship, AttributeValue};
use crate::extraction::AdvancedEntityExtractor;
use crate::embedding::store::EmbeddingStore;
use crate::cognitive::{CognitiveOrchestrator, CognitiveOrchestratorConfig};
...
mod tests {
    ...
    impl DocumentProcessingPipeline {
        async fn new() -> Self {
            ...
            let storage = PersistentMMapStorage::new(&storage_path, 50 * 1024 * 1024) // 50MB
        ...
        fn assess_extraction_quality(&self, extraction: &crate::extraction::ExtractionResult, content: &str) -> f32 {
    ...
    struct DocumentProcessingResult {
        ...
        processing_times: ProcessingTimes,
        extraction_result: crate::extraction::ExtractionResult,
    }
