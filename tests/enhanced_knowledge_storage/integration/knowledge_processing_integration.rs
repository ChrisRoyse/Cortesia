...
mod tests {
    ...
    async fn create_processing_pipeline() -> (
        ...
        let storage = PersistentMMapStorage::new(&storage_path, 1024 * 1024) // 1MB
    ...
    async fn test_knowledge_quality_validation_integration() {
        ...
        let high_quality_entities: Vec<_> = quality_metrics.iter()
            ...
            .map(|(doc_id, _, _)| crate::extraction::Entity {
                        ...
                        if !cleaned_document.is_empty() && cleaned_document.len() > 10 {
                            match extractor.extract_entities_and_relations(&cleaned_document).await {
                                ...
                                Err(_) => {
                                    ...
                                    let fallback_extraction = crate::extraction::ExtractionResult {
                                        entities: vec![
                                            crate::extraction::Entity {
                            ...
                            let skip_extraction = crate::extraction::ExtractionResult {
                                entities: vec![],
                                relations: vec![],
                            };
