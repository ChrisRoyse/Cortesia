...
impl BloomFilterUpdater {
    ...
    pub async fn update_entity(&self, _entity_id: u32, _old_data: &EntityData, new_data: &EntityData) -> Result<()> {
...
impl CSRUpdater {
    pub fn new(_csr_storage: Arc<RwLock<CSRGraph>>) -> Self {
...
impl EmbeddingUpdater {
    ...
    pub async fn update_entity(&self, entity_id: u32, _old_data: &EntityData, new_data: &EntityData) -> Result<()> {
    ...
    pub async fn add_triple(&self, triple: &Triple) -> Result<()> {
        ...
        let _embedding = self.generate_triple_embedding(triple).await?;
    ...
    pub async fn remove_triple(&self, _triple: &Triple) -> Result<()> {
